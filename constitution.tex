...
%The first two are pretty ambiguous and don't really reflect what we actually do. "Educational programming" makes CSH sound like a TV network. Also, just fixed some grammatical errors.
	\begin{enumerate}
	\item To enhance the educational experience of its members.
...
%"From which is derives its authority" is incorrect, CSH's authority to operate doesn't come from the guidelines we have been given by ResLife.
...
\begin{itemize}
\item An explicit definition of the committee's responsibilities and expectations. 
\item Expectations pertaining to the committee's conduct and procedures.
